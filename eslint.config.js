...
export default tseslint.config(
  { ignores: ["dist"] },
  {
    ...
    rules: {
      ...
      // react-hooks v7 compiler-backed rules — all pre-existing violations
      // refactored (lazy state init, useSyncExternalStore, render-phase
      // adjustments, async-fetch effects with justified suppressions).
      // Enforced as errors so regressions block CI.
