...
// Development fallback configuration (for demo purposes only)
...
const firebaseConfig = (() => {
  ...
  // In production without config, use production config anyway (will surface proper error)
  return productionConfig;
})();
...
export const isFirebaseEnabled: boolean = (() => {
  // Always enable in production (even if config is missing, to surface proper error)
