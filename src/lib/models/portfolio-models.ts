...
export type PortfolioSettingsModel = z.infer<
  typeof PortfolioSettingsModelSchema
>;
...
export const validatePortfolioSettings = (
  data: unknown
...
export const transformProjectForFirestore = (
...
export const transformSkillForFirestore = (
  skill: SkillModel
): Record<string, unknown> => {
  return {
    ...skill,
...
export const transformExperienceForFirestore = (
