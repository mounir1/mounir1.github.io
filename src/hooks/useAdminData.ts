...
export function useAdminData(): UseAdminDataReturn {
  ...
  const loadSkills = useCallback(async () => {
    try {
      ...
      const err =
        error instanceof Error ? error : new Error('Failed to load skills');
      setLastError(err);
      toast({
    ...
    try {
      ...
      const err =
        error instanceof Error
          ? error
          : new Error('Failed to load experiences');
      setLastError(err);
      toast({
  ...
  const refreshData = useCallback(async () => {
    ...
    await Promise.all([loadProjects(), loadSkills(), loadExperiences()]);
  ...
  const createProject = useCallback(
    async (data: ProjectInput): Promise<string | null> => {
      try {
  ...
  const updateProject = useCallback(
    async (id: string, data: Partial<ProjectInput>): Promise<boolean> => {
      try {
  ...
  const createSkill = useCallback(
    async (data: SkillInput): Promise<string | null> => {
      try {
  ...
  const updateSkill = useCallback(
    async (id: string, data: Partial<SkillInput>): Promise<boolean> => {
      try {
  ...
  const createExperience = useCallback(
    async (data: ExperienceInput): Promise<string | null> => {
      try {
  ...
  const updateExperience = useCallback(
    async (id: string, data: Partial<ExperienceInput>): Promise<boolean> => {
      try {
        ...
        const err =
          error instanceof Error
            ? error
            : new Error('Failed to update experience');
        setLastError(err);
        toast({
          title: 'Error',
          description: err.message,
    ...
    async (id: string): Promise<boolean> => {
      try {
        ...
        const err =
          error instanceof Error
            ? error
            : new Error('Failed to delete experience');
        setLastError(err);
        toast({
          title: 'Error',
          description: err.message,
  ...
  const batchUpdateProjects = useCallback(
    async (
      updates: Array<{ id: string; data: Partial<ProjectInput> }>
    ): Promise<boolean> => {
      try {
        ...
        const err =
          error instanceof Error ? error : new Error('Failed to batch update');
        setLastError(err);
        toast({
          title: 'Error',
          description: err.message,
  ...
  const deduplicateAllData = useCallback(async () => {
    try {
      ...
      const err =
        error instanceof Error ? error : new Error('Failed to deduplicate');
      setLastError(err);
      toast({
        title: 'Error',
        description: err.message,
  ...
  const runQualityCheck = useCallback(async () => {
    try {
      ...
      const err =
        error instanceof Error ? error : new Error('Quality check failed');
      setLastError(err);
      toast({
        title: 'Error',
        description: err.message,
  ...
  const stats = useMemo((): DataStats => {
    ...
    const recentlyUpdated = projects.filter(
      p => p.updatedAt && p.updatedAt > last30Days
    ).length;
