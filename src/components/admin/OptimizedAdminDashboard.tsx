...
export function OptimizedAdminDashboard() {
  ...
  return (
    <div className="admin-dashboard min-h-screen bg-background">
      ...
      {/* Admin Stats */}
      <div className="admin-dashboard-grid grid grid-cols-1 gap-4 p-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div className="admin-dashboard-grid grid grid-cols-1 p-4">
        ...
        <main className="col-span-12">
          ...
          <Tabs
            ...
            className="w-full"
          >
            <TabsList className="mb-6 grid h-auto w-full grid-cols-2 rounded-lg bg-muted p-1 sm:h-12 sm:grid-cols-4">
              <TabsTrigger
                value="overview"
                className="track-click flex items-center gap-2 rounded-md py-2 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm"
                onClick={() => {
                  pushToDataLayer({
