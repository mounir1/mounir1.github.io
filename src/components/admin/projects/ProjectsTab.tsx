  ...
  const handleBulkAction = useCallback(() => {
    if (selectedProjects.length > 0) {
      ...
      toast({
        ...
        description:
          'Please select one or more projects to perform bulk actions.',
        variant: 'destructive',
      });
    }
  }, [selectedProjects]);
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Manage your portfolio projects with advanced filtering and bulk
                operations
              </CardDescription>
            </div>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {filteredProjects.map(project => (
                  <ProjectCard
                    ...
                    onSelect={selected =>
                      handleProjectSelect(project, selected)
                    }
