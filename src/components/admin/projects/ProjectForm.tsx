...
export function ProjectForm({
  ...
  const addArrayItem = useCallback(
    (fieldName: keyof ProjectFormData, value: string) => {
  ...
  const removeArrayItem = useCallback(
    (fieldName: keyof ProjectFormData, index: number) => {
      const currentValue = form.getValues(fieldName) as string[];
      form.setValue(
        fieldName,
                          ...
                          <FormItem>
                            ...
                            >
                              ...
                              <SelectContent>
                                ...
                                <SelectItem value="Enterprise Integration">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            This will be shown in project cards and search
                            results (max 500 characters)
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                      ...
                      <div className="mb-2 mt-2 space-y-2">
                        {form.watch('challenges').map((challenge, index) => (
                          ...
                          >
                            ...
                            <X
                              className="mt-0.5 h-4 w-4 cursor-pointer text-muted-foreground hover:text-destructive"
                              onClick={() =>
                                removeArrayItem('challenges', index)
                              }
                            />
                          </div>
                        ))}
                          ...
                          .map((collaborator, index) => (
                            ...
                            >
                              ...
                              <X
                                className="h-3 w-3 cursor-pointer"
                                onClick={() =>
                                  removeArrayItem('collaborators', index)
                                }
                              />
                            </Badge>
                          ))}
