...
export const initialProjects: ProjectInput[] = [
  ...
  // ── 14. mounirtms — Magento TMS Modules ─────────────────────────────────────
  {
    title: "mounirtms — Magento 2 TMS & Logistics Modules",
    description:
      "Open-source Magento 2 module library for Transport Management Systems (TMS) — carrier integrations (DHL, FedEx, local), shipping automation, real-time tracking, and multi-carrier rate shopping. A separate project from MAB Modules, focused purely on logistics.",
    longDescription:
      "A dedicated open-source Magento 2 module library focused on Transport Management Systems and logistics. Covers plug-and-play carrier integrations, an automated shipping rule engine for rate optimisation, real-time delivery tracking via webhooks, warehouse dispatch workflows, and multi-carrier rate shopping at checkout. Distributed via Packagist / Composer for easy merchant adoption.",
    category: "E-commerce",
    status: "active",
    achievements: [
      "Open-source TMS modules published for the Magento 2 ecosystem",
      "Multi-carrier shipping integration: DHL, FedEx, local carriers",
      "Automated shipping rule engine for rate optimisation",
      "Real-time delivery tracking with webhook status updates",
      "Warehouse dispatch workflow automation",
      "Packagist-distributed, Composer-installable modules",
    ],
    technologies: [
      "PHP", "Magento 2", "MySQL", "XML",
      "REST APIs", "GraphQL", "Composer", "Docker", "Elasticsearch",
    ],
    tags: ["magento", "tms", "logistics", "shipping", "open-source", "carrier-integration", "ecommerce"],
    ...
    clientInfo: {
      ...
      size: "startup",
      location: "GitHub",
      website: "https://mounirtms.github.io",
      isPublic: true,
    },
    metrics: {
      performanceImprovement: "Shipping cost reduction via multi-carrier rate shopping",
      customMetrics: {
        module_type: "TMS & Logistics",
        platform: "Magento 2",
        distribution: "Packagist / Composer",
        carrier_integrations: "DHL, FedEx, local carriers",
      },
    },
    challenges: [
      "Abstracting multiple carrier APIs into one unified interface",
      "Real-time rate calculation at checkout without adding latency",
      "Supporting complex shipping rules per region and product type",
    ],
    solutions: [
      "Built a carrier adapter pattern for plug-and-play per-carrier modules",
      "Async rate caching with Redis for sub-100ms checkout responses",
      "Flexible rule engine with priority-based shipping matrix",
    ],
    teamSize: 1,
  ...
  // ── 15. TechnoStationery Dashboard — AI Operations Hub ─────────────────────
  {
    title: "TechnoStationery Dashboard — AI-Powered Operations Hub",
    description:
      "Unified task management, real-time server monitoring, and AI-generated reporting platform. Integrates Telegram & Slack bots for instant alerts, and OpenAI for automated weekly/monthly operational summaries.",
    longDescription:
      "A comprehensive internal operations dashboard for TechnoStationery combining task management workflows, live server and infrastructure monitoring, bot integrations (Telegram alerts, Slack notifications), and AI-powered reporting. Provides a single pane of glass for the engineering and ops team — tracking open tasks, deployment statuses, server health (CPU, RAM, disk, uptime, cron jobs), and auto-generating readable weekly/monthly performance summaries using OpenAI.",
    category: "Web Application",
    status: "in-development",
    achievements: [
      "Unified task management + server monitoring in one dashboard",
      "Telegram & Slack bot integration for real-time operational alerts",
      "AI-generated weekly/monthly reports via OpenAI API",
      "Live server health monitoring: CPU, RAM, disk, uptime, cron jobs",
      "Automated failure alerts with intelligent escalation rules",
      "Role-based access control for engineering and ops teams",
    ],
    technologies: [
      "React", "TypeScript", "Node.js", "Firebase",
      "Telegram Bot API", "Slack API", "OpenAI API",
      "Prometheus", "Grafana", "WebSocket", "Docker", "Nginx",
    ],
    tags: ["dashboard", "monitoring", "task-management", "ai", "bots", "automation", "operations"],
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=600&fit=crop",
    logo: "/dashboard-technostationery-logo.svg",
    icon: "📊",
    liveUrl: "https://dashboard.technostationery.com",
    githubUrl: "",
    demoUrl: "https://dashboard.technostationery.com",
    caseStudyUrl: "",
    featured: true,
    disabled: false,
    priority: 92,
    ...
    metrics: {
      performanceImprovement: "80% reduction in manual reporting time",
      customMetrics: {
        servers_monitored: "10+",
        bot_integrations: "Telegram + Slack",
        ai_reports: "Weekly + Monthly auto-generated",
        alert_response_time: "< 30 seconds",
      },
    },
    challenges: [
      "Unifying disparate monitoring tools into one coherent UI",
      "Generating readable AI reports from raw operational metrics",
      "Real-time bot alert routing without notification fatigue",
    ],
    solutions: [
      "Built a unified metrics aggregation layer from multiple sources",
      "Integrated OpenAI to summarise metrics into actionable narrative reports",
      "Intelligent alert filtering and escalation rules for bots",
    ],
    teamSize: 2,
