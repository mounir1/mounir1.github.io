...
export const initialProjects: ProjectInput[] = [
  ...
  },
  {
    ...
    description:
      'Omnichannel retail management solution using Cegid Retail Y2, connecting physical stores with e-commerce platforms.',
    longDescription:
  ...
  },
  {
    ...
    description:
      'Next-gen Property Management System (PMS) for a hotel chain, featuring booking engine, housekeeping, and revenue management.',
    longDescription:
  ...
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1507537297725-24a1c434c175?w=800&h=600&fit=crop',
  ...
  },
  {
    ...
    description:
      'High-performance server infrastructure setup and management using Linux, Docker, and Kubernetes for scalable applications.',
    longDescription:
    ...
    image:
      'https://images.unsplash.com/photo-1558494949-ef526b0042a0?w=800&h=600&fit=crop',
