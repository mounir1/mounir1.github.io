...
export const serviceOfferings: ServiceOffering[] = [
  ...
  },
  {
    ...
    technologies: ['AWS', 'Kafka', 'Node.js', 'Docker', 'Various APIs'],
    timeline: '3-6 weeks',
    price: 'Custom Quote',
  },
  {
    ...
    technologies: ['Akeneo', 'Pimcore', 'Node.js', 'Docker', 'PostgreSQL'],
    timeline: '4-8 months',
    price: 'Custom Quote',
  },
  {
    ...
    technologies: ['Magento 2', 'PHP', 'GraphQL', 'MySQL', 'REST APIs'],
    timeline: '2-6 months',
    price: 'Custom Quote',
  },
  {
    ...
    technologies: ['Node.js', 'Kafka', 'RabbitMQ', 'PostgreSQL', 'AWS Lambda'],
    timeline: '4-12 weeks',
    price: 'Custom Quote',
  },
  {
